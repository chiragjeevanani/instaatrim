      ...
      <div className="flex items-center justify-between gap-1.5 mb-1.5 w-full">
        ...
        <div className="flex items-center gap-1.5 shrink-0" data-purpose="reward-actions">
          ...
          <button
            ...
            className="flex items-center gap-1 bg-[#2e1065] text-white px-2 py-0.5 h-[26px] rounded-full text-left active:scale-95 transition-transform"
          >
          ...
          <button
            ...
            className="flex flex-col items-center justify-center bg-[#1e1035] text-white px-2.5 h-[26px] rounded-full border border-purple-800/40 active:scale-95 transition-transform min-w-[38px]"
          >
          ...
          {cartItems.length > 0 && (
            <button
              ...
              className="relative p-1 bg-brand-maroon text-white rounded-full shadow-xs active:scale-95 transition-transform"
              title="View Cart"
            >
              <ShoppingBag className="w-3 h-3" />
              <span className="absolute -top-1 -right-1 bg-amber-400 text-stone-900 text-[8px] font-extrabold w-3 h-3 rounded-full flex items-center justify-center border border-white">
                {cartItems.length}
              </span>
            </button>
          )}
